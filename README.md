...
For the details how node IGP's and routing, please have a look to configurations under the configs folder. Please note: there could some configuration items which are unnecessary or partially done in some nodes (Telemetry, twamp, QoS, netconf can be ignored)
...
>>>>>>> 9e4df80... new readme and small config changes
